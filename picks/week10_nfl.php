...
<div class="picks-weekly">
	...
	<img src="../img/111515-bradford-hurt-1200.jpg" class="picks-pic">
	<p class="picks-talk">
	</P>
	...
	<h3 class="loser">New Orleans -1</h3>
	...
	<h3 class="loser">Philadelphia -6</h3>
