...
<div class="picks-weekly">
 ...
 <h3 class="loser">Penn State +1</h3> 
	...
	<h3 class="loser">Texas Tech vs West Virginia over 81</h3> 
 ...
 <h3 class="my-picks">NC State -4</h3> 
	...
	<h3 class="loser">Wisconsin -10.5</h3> 
	...
	<h3 class="loser">Iowa vs Indiana under 60</h3> 
 ...
 <h3 class="my-picks">Washington State -3</h3> 
	...
	<h3 class="loser">Michigan State -6.5</h3> 
	...
	<h3 class="loser">Washington -2</h3> 
  ...
  <h3 class="loser">LSU +7</h3> 
	...
	<h3 class="loser">Ohio State -22</h3> 
