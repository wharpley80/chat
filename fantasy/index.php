...
<body>
	...
	<div class="fantasy-intro">
		...
		<h3>Antonio Brown</h3>
		<h4>$8,100 Draft Kings (49.6 Pts)</h4>
		...
		<h4>$3,900 Draft Kings</h4>
			<p class="fantasy-body">Chargers can't run block to save their lives. They actually tried to commit to the run last week for the first
				...
				to. Gates isn't 100% and S.Johnson has be injured and inconsistent. Home game for the Chargers, Bears are 18th in fantasy points allowed
				to WR and are 4th in total pass defense. Not the best matchup, but good value for the price.
			</P>
		<h3>Jonathan Stewart</h3>
		<h4>$4,300 Draft Kings (7.8 Pts)</h4>
		...
		<h3>Chris Ivory</h3>
		<h4>$5,900 Draft Kings (19.8 Pts)</h4>
		...
		<h4>$6,300 Draft Kings (17.24 Pts)</h4>
		...
		<h4>$5,200 Draft Kings (18.36 Pts)</h4>
