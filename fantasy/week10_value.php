...
<a name="week10-fantasy"></a>
<div class="fantasy-intro">
	<h2 class="fantasy-title">Daily Fantasy Value Picks</h2>
	<img src="../img/dt.common.streams.StreamServer.jpeg" class="fantasy-pic">
	<h3>Aaron Rodgers</h3>
	<h4>$7,500 Draft Kings (25.12 Pts, .33 VPD)</h4>
		<p class="fantasy-body">Yes Rodgers is the most expensive QB behind Brady this week, but this is about the Value Per Dollar
			...
			the toughest 2 game stretch that he will have all year (@DEN, @CAR). This will be a get right situation for Rodgers facing the 18th ranked pass defense and a team that is 29th in fantasy points allowed to QBs. Expect a BIG game from Rodgers as he gets back on track. 
		</p>
	<h3>Jordan Reed</h3>
	<h4>$4,600 Draft Kings (17.9 Pts, .39 VPD)</h4>
		<p class="fantasy-body">Reed when healthy is almost uncoverable by linebackers. Problem is that he is often injured and 
			has had inconsistent QB play to get him the ball. Reed is healthy and this is a favorable mathcup for him in a home game vs the Saints. NO ranks 30th in pass defense and they are 31st in defending the TE position. All considered Reed is the only 10th highest cost at TE, which to me looks like great value.
		</p>
	<h3>Doug Martin</h3>
